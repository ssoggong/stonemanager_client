...
function Schedulle() {
    const events = [
        ...
        { title: '크리스마스파티', date: '2020-12-25', backgroundColor: 'orange' }
    ];
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <Link to='/schedullle'><button type="button" class="btn btn-primary" > 확인 </button></Link>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <Link to='/schedule'><button type="button" class="btn btn-danger" >삭제</button></Link>
                        </div>
                    </div>
                </div>
            </div>
